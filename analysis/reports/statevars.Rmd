...
The maximum statevars are `s0 = ` `r max(sv_maxima$max_s0)`; `n0 = ` `r max(sv_maxima$max_n0)`. There are a total of `r length(unique(sv_maxima$site))` sites (route-region combinations). 
